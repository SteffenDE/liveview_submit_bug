defmodule SubmitBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SubmitBugWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SubmitBugWeb.Gettext, "errors", msg, opts)
    end
  end
